...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/hummingbird-project/hummingbird.git", from: "2.18.2"),
        ...
        .package(url: "https://github.com/hummingbird-project/swift-jobs.git", from: "1.3.1"),
