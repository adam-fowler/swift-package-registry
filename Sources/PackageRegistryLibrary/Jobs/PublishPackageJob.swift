...
>: Sendable {
    ...
    func extractManifestsFromZipFile(sourceArchive: ByteBuffer, logger: Logger) async throws -> Manifests? {
        do {
            ...
            let zipArchiveReader = try ZipArchiveReader(buffer: sourceArchive.readableBytesView)
